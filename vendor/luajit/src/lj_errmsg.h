...
/* Lua 5.4 local attribute support (LuaJIT-5.4 port). */
ERRDEF(XATTR,	"unknown attribute " LUA_QS)
ERRDEF(XCONST,	"attempt to assign to const variable " LUA_QS)
ERRDEF(XCLOSE,	"to-be-closed variables (" LUA_QL("<close>") ") are not supported by this LuaJIT-5.4 port")
